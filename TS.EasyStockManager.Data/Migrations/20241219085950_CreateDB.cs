    ...
    public partial class CreateDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 12, 19, 14, 29, 49, 818, DateTimeKind.Local).AddTicks(7909), "EX01", "Example Store" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 12, 19, 14, 29, 49, 680, DateTimeKind.Local).AddTicks(337), "Stock Receipt" },
                    { 2, new DateTime(2024, 12, 19, 14, 29, 49, 687, DateTimeKind.Local).AddTicks(914), "Stock Out" },
                    { 3, new DateTime(2024, 12, 19, 14, 29, 49, 687, DateTimeKind.Local).AddTicks(928), "Transfer" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 12, 19, 14, 29, 49, 688, DateTimeKind.Local).AddTicks(3634), "pc", "Piece" },
                    { 2, new DateTime(2024, 12, 19, 14, 29, 49, 688, DateTimeKind.Local).AddTicks(3763), "kg", "Kilogram" },
                    { 3, new DateTime(2024, 12, 19, 14, 29, 49, 688, DateTimeKind.Local).AddTicks(3769), "m", "Meter" }
                });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "CreateDate", "Email", "Name", "Password", "Surname" },
                values: new object[] { 1, new DateTime(2024, 12, 19, 14, 29, 49, 818, DateTimeKind.Local).AddTicks(2611), "admin@admin.com", "Admin", "827ccb0eea8a706c4c34a16891f84e7b", "Admin" });

            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "Id", "Barcode", "CategoryId", "CreateDate", "Description", "Image", "Price", "ProductName", "UnitOfMeasureId" },
                values: new object[] { 1, "EX01", null, new DateTime(2024, 12, 19, 14, 29, 49, 819, DateTimeKind.Local).AddTicks(1588), null, null, 1m, "Example Product", 1 });
